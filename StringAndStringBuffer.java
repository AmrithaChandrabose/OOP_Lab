...
class StringAndStringBuffer
 {
	public static void main(String[] args)
	{
		...
		int p = s.length();
		int q = s.capacity();
		System.out.println("Length of string Neeraj=" + p);
		System.out.println("Capacity of string Neeraj=" + q);
		s.append("Singh");
		System.out.println("After Appending="+s);
		s.insert(7, "-");
		System.out.println("After inserting - @possition 7="+s);
		s.reverse();
		System.out.println("After reversing ="+s);
		s.delete(0, 2);
        System.out.println("After deleting the array from 0 to 2 possition="+s);
        s.deleteCharAt(1);
        System.out.println("After deleting a character @1 possition="+s);
        s.replace(0,5,"a");
